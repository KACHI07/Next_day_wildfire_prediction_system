...
pattern="/content/drive/MyDrive/Wildfire/next_day_wildfire_spread_train_*.tfrecord"
train_dataframes = process_tfrecords(pattern, 1)

pattern="/content/drive/MyDrive/Wildfire/next_day_wildfire_spread_test_*.tfrecord"
